...
public final class ActivitySalelistBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySalelistBinding(@NonNull LinearLayoutCompat rootView,
  ...
  @NonNull
  public static ActivitySalelistBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySalelistBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_salelist, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySalelistBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySalelistBinding((LinearLayoutCompat) rootView, container, containerlay,
          top);
    }
