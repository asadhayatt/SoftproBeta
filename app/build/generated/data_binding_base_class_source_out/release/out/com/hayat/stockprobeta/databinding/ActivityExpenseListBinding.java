...
public final class ActivityExpenseListBinding implements ViewBinding {
  ...
  private ActivityExpenseListBinding(@NonNull LinearLayoutCompat rootView, @NonNull EditText ETDt,
  ...
  public static ActivityExpenseListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityExpenseListBinding((LinearLayoutCompat) rootView, ETDt, container,
